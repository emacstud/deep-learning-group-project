...
- **`metadata_analysis.ipynb`** [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1jfSTHSXvVIU8Fgc79sCz6F0nWiLvRRKd?usp=sharing) — exploratory analysis of the TruckScenes condition tags (condition distribution analysis across train/val splits, cross-condition gap identification, per-class composition by condition, camera position analysis) and construction of the stratified holdout split used by `main.ipynb`.
- **`radar_viz.ipynb`** [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/15r72zsYgUAaW14znvPv247OyWqpX1Mc8?usp=sharing) — qualitative comparison on failure cases, which motivates camera-radar fusion for future research.
